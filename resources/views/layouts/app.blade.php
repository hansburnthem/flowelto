                        ...
                        <div class="rounded-lg shadow-lg ring-auto ring-black ring-opacity-5 overflow-hidden">
                            <div class="z-30 relative p-2 text-black flex flex-col">
                                ...
                                @if(auth()->user()->role->role_name == 'Manager')
                                    ...
                                    <a href="{{ route('view_cart') }}" class="p-1 hover:bg-pink-300 hover:text-white duration-300 rounded-lg mt-1" style="color:black">My Cart</a>
                                    <a href="{{ route('view_transactions') }}" class="p-1 hover:bg-pink-300 hover:text-white duration-300 rounded-lg" style="color:black">Transaction History</a>
                                    @endif
